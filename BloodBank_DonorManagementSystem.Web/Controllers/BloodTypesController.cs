    ...
    public class BloodTypesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.BloodTypes != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.BloodTypes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("BloodGroupName,Id")] BloodType bloodType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BloodGroupName,Id")] BloodType bloodType)
        {
            if (id != bloodType.Id)
            {
                return NotFound();
